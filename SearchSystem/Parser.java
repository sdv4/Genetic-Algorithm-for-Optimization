...
* Parser.java
*
* Class whose instances can be used to parse input files of the form described at
* https://pages.cpsc.ucalgary.ca/~denzinge/courses/433-fall2017/assigninput.html
* to create an input list for instances of the OTS.java class.
*
* @author Kevin Naval
* @author Justina Lem
* @author Shane Sims
...
public class Parser {
	...
	*/
	private void parseCourses(BufferedReader buf) {
	    ...
	    try{
	      line = buf.readLine();												// read first entry to line
	      while(!line.equals("")){
